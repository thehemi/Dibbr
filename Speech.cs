...
public class SpeechCap
{
        ...
        var requestContent = new MultipartFormDataContent
    {
        ...
        var result = await client.PostAsync("/speech-api/v2/recognize?output=json&lang=en-US&key=AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw",requestContent).ConfigureAwait(false);
