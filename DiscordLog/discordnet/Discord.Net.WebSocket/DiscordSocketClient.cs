                            ...
                            case "MESSAGE_CREATE":
                                {
                                    ...
                                    if (true)//State.GetChannel(data.ChannelId) is ISocketMessageChannel channel)
                                    {
                                        var guild = (channel as SocketGuildChannel)?.Guild;
                                        ...
                                        if (author == null)
                                        {
                                            ...
                                            {
                                                var id = channel != null ? channel.Id : data.ChannelId;
                                                if (channel == null)
                                                    channel = channel;
                                                await UnknownChannelUserAsync(type, data.Author.Value.Id, id).ConfigureAwait(false);
                                                return;
                                            }
                                        }
